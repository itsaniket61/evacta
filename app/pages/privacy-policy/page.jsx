...
function PrivacyPolicyPage() {
  return (
    <div className='px-4 py-8 container mx-auto'>
      ...
      <p>
        Like any other website, Evacta uses &apos;cookies&apos;. These cookies
        store information, including visitors&apos; preferences and the pages on
        the website that the visitor accessed or visited. The information is
        used to optimize the users&apos; experience by customizing our web page
        content based on visitors&apos browser type and/or other information.
      </p>
      ...
      <p>
        Evacta&apos;s Privacy Policy does not apply to other advertisers or
        websites. Thus, we are advising you to consult the respective Privacy
        Policies of these third-party ad servers for more detailed information.
        Their policies may include their practices and instructions about how to
        opt out of certain options. You can find a complete list of these
